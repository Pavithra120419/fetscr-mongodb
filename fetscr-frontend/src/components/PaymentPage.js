...
const PaymentPage = () => {
  ...
  const [selectedUpiPlatform, setSelectedUpiPlatform] = useState(null); // "PhonePe" or "Google Pay" or "Paytm" or "BHIM"
    ...
    <div className="payment-container">
      ...
      {selectedPaymentMethod === "credit-card" && (
        <div className="credit-card-section">
          ...
          <button
            onClick={() =>
              navigate("/credit-card-payment", { state: { amount, plan } })
            }
          >
        ...
        <div className="upi-section">
          {!selectedUpiPlatform && (
            <>
              ...
              <button onClick={() => setSelectedUpiPlatform("BHIM")}>BHIM</button>
              <button onClick={() => setSelectedPaymentMethod(null)}>Back</button>
            </>
          )}
          ...
          {selectedUpiPlatform && (
            <>
              <h3>{selectedUpiPlatform} UPI Payment</h3>
              <p>
                Amount: <b>₹{amount}</b>
              </p>
